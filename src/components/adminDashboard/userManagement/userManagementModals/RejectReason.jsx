...
import RejectionSuccess from "../userManagementModals/RejectionSuccess";
...
const RejectReason = () => {
  ...
  return (
    <>
        ...
        <div className="bg-white w-[45%] rounded-xl shadow-lg p-6 flex flex-col gap-3">
          ...
          <div className="flex gap-3 font-semibold text-base">
            ...
            <div
              ...
              onClick={() => {
                setShowRejectionSuccess(true) ? setShowReason(false) : setShowRejectionSuccess(false)
              }}
            >
      ...
      {
        showRejectionSuccess && <RejectionSuccess/>
      }
    </>
  );
}

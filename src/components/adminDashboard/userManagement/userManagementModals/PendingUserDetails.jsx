...
const PendingUserDetails = ({
  ...
  return (
    <div className="bg-black bg-opacity-80 backdrop-blur-sm fixed h-screen z-10 w-full flex items-center justify-center inset-0">
      <div className="flex flex-col gap-2 py-2 px-6 max-w-[500px] w-full rounded-xl bg-white shadow-lg relative">
        ...
        <div className="flex flex-col gap-6 mt-3">
          <div className="flex gap-3">
            ...
            <div>
              <h3 className="font-sanns font-medium text-2xl text-[#000000]">
                Udo Agonsi
              </h3>
              <div className="flex gap-3 font-sanns font-normal text-base text-[rgba(0,0,0,0.5)]">
                <p className="pr-3 border-r-2 border-e-red-950">
                  udoagonsi@gmail.com
                </p>
          ...
          <div className="flex gap-4 pb-8 border-b border-[rgba(0,0,0,0.5)] items-center ">
            <h4 className="font-semibold text-base text-[#1e1e1e]">
          ...
          <div className="flex gap-9 pb-8 border-b-[0.5px] border-[rgba(0,0,0,0.5)]">
            <div className="flex flex-col gap-2">
              <h5 className="font-semibold text-base text-[#1e1e1e]">
                User Information
              </h5>
      ...
      {/* {showVerify && <ApproveVerification setShowVerify={setShowVerify} setShowPending={() => setShowPending(false)}/>} */}
...
export const HoverStat = ({ title, badge }) => {
  return (
    ...
    >
      <div className="w-1/2">
        <h5 className="font-manrope font-normal text-[10px] text-[rgba(0,0,0,0.5)]">
          {title}
        </h5>
      </div>
      <div
